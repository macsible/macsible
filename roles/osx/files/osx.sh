...
#
# Based on the .osx file from https://github.com/geerlingguy/dotfiles
# which in turn is based on the .osx file from https://github.com/mathiasbynens/dotfiles
# Tweaked for & by Dan Bohea, 2014.
...
# Doesn't always work - now handling this in Ansible
...
# Use dark menu bar and Dock ("dark mode")
# TODO: Not working on El Capitan.
...
# TODO: Setup what appears in the Finder sidebar (UPDATE: this looks really hard)
...
# TODO: Setup what items appear in the dock based on what apps have been installed (Ansible)
...
# ...and sorted by date (oldest at the top)
